...
class Info(commands.Cog): 
    ...
    async def regelwerk(self, ctx: discord.ApplicationContext, channel: Option(discord.TextChannel, "welchen channel rein schicken wilst")):
        ...
        await channel.send("<:px:1188544819493093457>")
